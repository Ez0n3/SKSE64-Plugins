...
bool RegisterFuncs(VMClassRegistry* registry)
{
	registry->RegisterFunction(
		// EzSkse64TestClass is defined in .\Data\Scripts\Source\EzSkse64TestClass.psc
		new NativeFunction0 <StaticFunctionTag, bool>("Test", "EzSkse64TestClass", Plugin_Example_Functions::Test, registry));
...
/*
// SKSE64 does not use this
__declspec(dllexport) int SKSEPluginVersionData SKSEPlugin_Version =
{
};
*/
